...
const std::string Base64URL::m_characters = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
                                         "abcdefghijklmnopqrstuvwxyz"
                                         "0123456789-_";

void Base64URL::Encode(const char* input, unsigned int length, std::string &output)
{
...
std::string Base64URL::Encode(const char* input, unsigned int length)
{
  std::string output;
...
void Base64URL::Encode(const std::string &input, std::string &output)
{
...
void Base64URL::Decode(const char* input, unsigned int length, std::string &output)
{
  if (input == NULL || length == 0)
    return;
...
std::string Base64URL::Decode(const char* input, unsigned int length)
{
  std::string output;
...
void Base64URL::Decode(const std::string &input, std::string &output)
{
