...
@class MainExternalTouchController;

@interface MainScreenManager : NSObject {
...
@property (assign, setter=setView:) MainEAGLView *_glView;

// init the screenmanager with our eaglview
//- (id)      initWithView:(MainEAGLView *)view;
