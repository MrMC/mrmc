...
const std::string CSettings::SETTING_LOOKANDFEEL_AUTOHIDEOSD = "lookandfeel.autohideosd";
...
const std::string CSettings::SETTING_PVRMENU_TVMENUTOGUIDE = "pvrmenu.tvmenutoguide";
...
const std::string CSettings::SETTING_DEBUG_UPLOAD = "debug.upload";
