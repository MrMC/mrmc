...
public:
  ...
  static const std::string SETTING_LOOKANDFEEL_RSSHOST;
  ...
  static const std::string SETTING_VIDEOPLAYER_DISABLELIMITEDTRESCALING;
  ...
  static const std::string SETTING_VIDEOPLAYER_USEMEDIACODECSURFACE_SD;
  static const std::string SETTING_VIDEOPLAYER_USEMEDIACODECSURFACE_CAPTURE;
  ...
  static const std::string SETTING_VIDEOPLAYER_USEVIDEOTOOLBOX_HEVC_HDR;
  static const std::string SETTING_VIDEOPLAYER_USEVDA;
  static const std::string SETTING_VIDEOPLAYER_USEAVF;
  ...
  static const std::string SETTING_PVRPLAYBACK_LIVETVWAIT;
  ...
  static const std::string SETTING_SMB_ENABLESMB2;
  ...
  static const std::string SETTING_VIDEOSCREEN_HASHDR;
  ...
  static const std::string SETTING_INPUT_RELOADKEYMAP;
  ...
  static const std::string SETTING_INPUT_APPLESIRIFOCUSEFFECTS;
  ...
  static const std::string SETTING_SERVICES_PLEXTRANSCODELOCALEXCLUSIONHEVC;
