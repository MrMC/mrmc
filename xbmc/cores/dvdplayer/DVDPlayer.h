...
public:
  ...
  int              IndexOf (StreamType type, const CDVDPlayer& p) const;
...
protected:
  ...
  */
  ...
  void SetCaching(ECacheState state, const std::string &msg);
  void LogCacheState(ECacheState state, const std::string &msg);
