...
#include "libdvd_types.h"
#include "libdvd_events.h"
 ...
 */
dvdnav_status_t dvdnav_set_region_mask(dvdnav_t *ctx, int32_t region_mask);
 ...
 * This has _nothing_ to do with the region setting of the DVD drive.
 */
dvdnav_status_t dvdnav_get_region_mask(dvdnav_t *ctx, int32_t *region_mask);
 ...
 */
dvdnav_status_t dvdnav_set_readahead_flag(dvdnav_t *ctx, int32_t read_ahead_flag);

/*
 * Query whether read-ahead caching/buffering will be used.
 */
dvdnav_status_t dvdnav_get_readahead_flag(dvdnav_t *ctx, int32_t *read_ahead_flag);
 ...
 */
dvdnav_status_t dvdnav_set_PGC_positioning_flag(dvdnav_t *ctx, int32_t pgc_based_flag);

/*
 * Query whether positioning is PG or PGC based.
 */
dvdnav_status_t dvdnav_get_PGC_positioning_flag(dvdnav_t *ctx, int32_t *pgc_based_flag);
 ...
 */
dvdnav_status_t dvdnav_current_title_info(dvdnav_t *ctx, int32_t *title,
                                          int32_t *part);
 ...
 */
dvdnav_status_t dvdnav_current_title_program(dvdnav_t *ctx, int32_t *title,
 ...
 */
dvdnav_status_t dvdnav_button_select_and_activate(dvdnav_t *ctx, pci_t *pci, int32_t button);
 ...
 */
dvdnav_status_t dvdnav_menu_language_select(dvdnav_t *ctx,
                                           char *code);

/*
 * Set which audio language we should use per default.
 */
dvdnav_status_t dvdnav_audio_language_select(dvdnav_t *ctx,
                                            char *code);

/*
 * Set which spu language we should use per default.
 */
dvdnav_status_t dvdnav_spu_language_select(dvdnav_t *ctx,
                                          char *code);
 ...
 * Get audio attr
 */
dvdnav_status_t dvdnav_get_audio_attr(dvdnav_t *ctx, uint8_t audio_mum, audio_attr_t *audio_attr);
 ...
 * Get spu attr
 */
dvdnav_status_t dvdnav_get_spu_attr(dvdnav_t *ctx, uint8_t audio_mum, subp_attr_t *subp_attr);
