...
public class XBMCSearchableActivity extends Activity
{
  ...
  private static final String TAG = "MrMCSearch";
  ...
  private void search(String query)
  {
    Cursor c = getContentResolver().query(
        Uri.parse("content://tv.mrmc.mrmc.media/search/" + query), null, null,
        null, null);
  ...
  private void doAction(Intent origIntent)
  {
    ...
    newIntent.setClass(this, tv.mrmc.mrmc.Main.class);
